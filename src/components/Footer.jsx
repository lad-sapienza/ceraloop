      ...
      <div className="mx-auto px-6 py-3 text-center text-sm text-gray-600 dark:text-gray-400">
        <span className="inline-flex items-center gap-2">
          ...
          <span>
            ...
            Julian Bogdani (
            <a className="underline hover:no-underline" href="mailto:julian.bogdani@uniroma1.it">julian.bogdani@uniroma1.it</a>
            ) · Lorenzo Cardarelli (
            <a className="underline hover:no-underline" href="mailto:lorenzo.cardarelli@uniroma1.it">lorenzo.cardarelli@uniroma1.it</a>
            )
          </span>
        </span>
      </div>
